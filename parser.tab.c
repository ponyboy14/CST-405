...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DeclList = 12,                  /* DeclList  */
  YYSYMBOL_Decl = 13,                      /* Decl  */
  YYSYMBOL_VarDecl = 14,                   /* VarDecl  */
  YYSYMBOL_StmtList = 15,                  /* StmtList  */
...
{
       0,    50,    50,    56,    59,    62,    63,    66,    84,    85,
      88,    89,    92,    93,    94,    97,    99,   155,   197
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "EQ", "OP", "NUMBER", "WRITE", "$accept", "Program",
  "DeclList", "Decl", "VarDecl", "StmtList", "Stmt", "ADDITION", "Expr", YY_NULLPTR
};
...
{
      -3,     6,     7,    -7,     8,    14,    -7,    -3,    -7,    -7,
      -1,    10,    11,     1,    -7,    -7,    -7,    -7,    -7,    -7,
      -7,    -7,    12,     3,    -7,    12
};
...
{
       8,     0,    15,    10,     0,     0,     2,     4,     5,     6,
       8,     0,     0,     0,    18,     1,     3,     9,    11,     7,
      14,    13,    17,     0,    14,    12
};
...
{
       1,     2,     3,     2,     3,    20,     4,    24,     4,    21,
      12,    21,    14,    13,    15,    18,    19,    25,     0,    23,
      16,     0,     0,     0,     0,    17
};
...
{
       0,     3,     4,     5,     9,    11,    12,    13,    14,    15,
      16,    18,     4,     6,     4,     0,    12,    15,     5,     5,
       4,     8,    17,     7,     4,    17
};
...
#line 1167 "parser.tab.c"
  ...
  case 12: /* ADDITION: ADDITION OP ADDITION  */
#line 92 "parser.y"
                                     { (yyval.number)=(yyvsp[-2].number)+(yyvsp[0].number); }
#line 1173 "parser.tab.c"
    break;

  case 13: /* ADDITION: NUMBER  */
#line 93 "parser.y"
...
#line 1179 "parser.tab.c"
  ...
  case 14: /* ADDITION: ID  */
#line 94 "parser.y"
             {(yyval.number)=getVal((yyvsp[0].string));}
...
#line 155 "parser.y"
		...
		if (semanticCheckPassed == 1) {
							...
							updateValue((yyvsp[-2].string),(yyvsp[0].number));
							char id2[50];
