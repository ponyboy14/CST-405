...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "EQ", "OP", "NUM", "WRITE", "$accept", "Program",
  "DeclList", "Decl", "VarDecl", "StmtList", "Stmt", "Expr", YY_NULLPTR
};
...
{
       8,     0,    12,    10,     0,     0,     2,     4,     5,     6,
       8,     0,     0,     0,    15,     1,     3,     9,    11,     7,
      13,    14
};
...
{
       1,     2,     3,     2,     3,    20,     4,    12,     4,    21,
      13,    14,    15,    18,    19,    17,     0,    16
};
...
#line 66 "parser.y"
									...
									if (inSymTab == 0) 
										addItem((yyvsp[-1].string), "Var", (yyvsp[-2].string),0, currentScope, "0");
									else
